...
type FileManager struct {
	...
	VirtualPath     string `gorm:"column:virtual_path;type:varchar(500);not null" json:"virtual_path"`
	VirtualName     string `gorm:"column:virtual_name;type:varchar(500);not null" json:"virtual_name"`
